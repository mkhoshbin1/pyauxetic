...
PyAuxetic is a Python plugin and library for modeling, analyzing, and post-procesing auxetic structures in Abaqus. Its main features are:
  ...
  + **Powerful API**: The software has a powerful API that can be used for scripting. All GUI functionality (and more) are available from the API. Scripting makes the results highly reproducable and the scripts can be archived.
  + **Extensible**: The software is built on an object-oriented framework, making it easily extensible. New structures and output types can be added very quickly and reliabily.
