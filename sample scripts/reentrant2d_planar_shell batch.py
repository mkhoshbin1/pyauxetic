...
from pyauxetic.main import main_batch
...
unit_cell_params_list.append( Reentrant2DUcpBox( 1, 5, 20, 24, 2.0, 1.5, 60) )
unit_cell_params_list.append( Reentrant2DUcpBox( 2, 5, 20, 24, 2.0, 1.5, 65) )
unit_cell_params_list.append( Reentrant2DUcpBox( 3, 5, 20, 24, 2.0, 1.5, 70) )
unit_cell_params_list.append( Reentrant2DUcpBox( 4, 5, 20, 24, 2.0, 1.5, 75) )
unit_cell_params_list.append( Reentrant2DUcpBox( 5, 5, 20, 24, 2.0, 1.5, 80) )
...
auxeticObj = main_batch(structure_type       , structure_prefix,
